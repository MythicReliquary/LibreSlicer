...
@REM /|/
@REM /|/ LibreSlicer is released under the terms of the AGPLv3 or higher
@REM /|/
...
@ECHO  Examples:
@ECHO.
@ECHO  Initial build:           build_win -d "c:\src\LibreSlicer-deps"
...
SET START_TIME=%TIME%
SET PS_START_DIR=%CD%
SET PS_SOLUTION_NAME=LibreSlicer
