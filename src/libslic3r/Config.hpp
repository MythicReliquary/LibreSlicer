...
// When parsing a configuration value, if the old_value is not understood by this LibreSlicer version,
// it is being substituted with some default value that this LibreSlicer could work with.
