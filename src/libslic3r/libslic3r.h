...
#define GCODEVIEWER_APP_NAME "LibreSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "LibreSlicerGcodeViewer"
...
using coord_t = 
#if 1
// Saves around 32% RAM after slicing step, 6.7% after G-code export (tested on LibreSlicer 2.2.0 final).
    int32_t;
#else
