...
// Loads filament while also moving towards given points in x-axis (x feedrate is limited by cutting the distance short if necessary)
    ...
    {
        // This is only supported by Prusa at this point (https://github.com/prusa3d/LibreSlicer/issues/3114)
    ...
    const std::string&  new_material)
{
    ...
    writer.feedrate(m_travel_speed * 60.f) // see https://github.com/prusa3d/LibreSlicer/issues/5483
