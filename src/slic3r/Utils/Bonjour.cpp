...
UdpSocket::UdpSocket( Bonjour::ReplyFn replyfn, const asio::ip::address& multicast_address, const asio::ip::address& interface_address, std::shared_ptr< asio::io_context > io_ctx)
	: replyfn(replyfn)
	, multicast_address(multicast_address)
	, socket(*io_ctx)
	, io_context(std::move(io_ctx))
{
	try {
		// open socket
...
UdpSocket::UdpSocket( Bonjour::ReplyFn replyfn, const asio::ip::address& multicast_address, std::shared_ptr< asio::io_context > io_ctx)
	: replyfn(replyfn)
	, multicast_address(multicast_address)
	, socket(*io_ctx)
	, io_context(std::move(io_ctx))
