...
void Tab::create_preset_tab()
{
    ...
    m_treectrl->Bind(wxEVT_TREE_SEL_CHANGED, [this](wxTreeEvent&) {
        ...
        // see https://github.com/prusa3d/LibreSlicer/issues/5720
...
//    wxWindowUpdateLocker noUpdates(this);
    ...
    if (m_presets_choice->IsShown())
        ...
        // (see https://github.com/prusa3d/LibreSlicer/issues/10746)
...
void Tab::on_value_change(const std::string& opt_key, const boost::any& value)
{
    ...
    if (m_postpone_update_ui) {
        ...
        // see https://github.com/prusa3d/LibreSlicer/issues/7146
        return;
    }
...
void TabPrint::update()
{
    ...
    // see https://github.com/prusa3d/LibreSlicer/issues/6814
...
void TabPrinter::build_print_host_upload_group(Page* page)
{
    ...
    wxString description_line_text = _L(""
        ...
        "into LibreSlicer/physical_printer directory.");
...
{
    // There is a bug related to Ubuntu overlay scrollbars, see https://github.com/prusa3d/LibreSlicer/issues/898 and https://github.com/prusa3d/LibreSlicer/issues/952.
