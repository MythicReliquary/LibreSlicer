...
# Output: out/LibreSlicer-v1.0.0-beta.1-win64-portable.zip
param(
...
$OutDir  = "out\win64"
$PkgRoot = "$OutDir\LibreSlicer-$Version"
...
$exe = Get-ChildItem -Recurse $buildDir -Filter *.exe | Where-Object { $_.Name -match 'libreslicer|aegis|orca' } | Select-Object -First 1
...
# Zip
$zipPath = "out\LibreSlicer-v$Version-win64-portable.zip"
