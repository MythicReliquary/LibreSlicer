...
The purpose of this guide is to describe how to contribute to the LibreSlicer translations. We use GNUgettext for extracting string resources from the project and PoEdit for editing translations.
...
https://github.com/MythicReliquary/LibreSlicer/tree/main/resources/localization
2. Open this file in PoEdit as "Edit a translation"
3. Apply your corrections to the translation
4. Push changed LibreSlicer.po and LibreSlicer.mo (will create automatically after saving of LibreSlicer.po in PoEdit) into the original folder.

### Scenario 2. How do I add a new language support
1. Get file LibreSlicer.pot here :
https://github.com/MythicReliquary/LibreSlicer/tree/main/resources/localization
2. Open it in PoEdit for "Create new translation"
3. Select Translation Language (for example French).
4. As a result you will have fr.po - the file containing translation to French.
Notice. When the translation is complete you need to:
    - Rename the file to LibreSlicer.po
    - Click "Save file" button. LibreSlicer.mo will be created immediately
    - Both LibreSlicer.po and LibreSlicer.mo have to be saved here:
https://github.com/MythicReliquary/LibreSlicer/tree/main/resources/localization/fr
( name of folder "fr" means "French" - the translation language). 

### Scenario 3. How do I add a new text resource when implementing a feature to LibreSlicer
Each string resource in LibreSlicer available for translation needs to be explicitly marked using L() macro like this:
```C++
...
### Scenario 4. How do I use GNUgettext to localize my own application taking LibreSlicer as an example

1.  For convenience create a list of files with this macro `L(s)`. We have 
https://github.com/MythicReliquary/LibreSlicer/tree/main/resources/localization/list.txt.

2.  Create template file(*.POT) with GNUgettext command:
    ```
        xgettext --keyword=L --add-comments=TRN --from-code=UTF-8 --debug -o LibreSlicer.pot -f list.txt
    ```
...
## General guidelines for LibreSlicer translators
...
- To check how the translated text looks on the UI elements, test it :) If you use *PoEdit*, all you need to do is save the file. At this point, a MO file will be created. Rename it LibreSlicer.mo, and you can run LibreSlicer (see above).

- If you see an encoding error (garbage characters instead of Unicode) somewhere in LibreSlicer, report it. It is likely not a problem of your translation, but a bug in the software.
